...
# file_name = 'out.txt'
# file = open(file_name, mode='w', encoding='cp1251')  # mode (режим): запись символьная, кодировка по умолчанию utf8
...
# file_name = 'out.txt'
# file = open(file_name, mode='r+', encoding='cp1251')  # mode (режим): чтение с записью
# file_content = file.read()
# file.write('\n' + 'appended line!')
# file.close()
# print(file_content)
